...
const base = 'group flex justify-center border-2 border-gray-700 py-4'
const motion = 'transition-all duration-200 ease-in hover:translate-y-[-2px] hover:shadow-lg hover:shadow-[0_4px_10px_#0F2F24]/40'
